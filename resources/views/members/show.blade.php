...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mb-3 row">
                <label for="staticNIA" class="col-sm-2 col-form-label">NIA</label>
                <div class="col-sm-10">
            ...
            <div class="mb-3 row">
                <label for="staticProdi" class="col-sm-2 col-form-label">Program Studi</label>
                <div class="col-sm-10">
            ...
            <div class="mb-3 row">
                <label for="staticAlamatAsal" class="col-sm-2 col-form-label">Alamat Asal</label>
                <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" id="staticAlamatAsal" value="{{ $member->alamat_asal }}">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="staticAlamatSekarang" class="col-sm-2 col-form-label">Alamat Sekarang</label>
                <div class="col-sm-10">
